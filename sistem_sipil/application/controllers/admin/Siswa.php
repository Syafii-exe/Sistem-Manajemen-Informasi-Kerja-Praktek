	...
	function update_siswa(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_siswa->update_siswa($kode,$nis,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$alamat,$kontak,$photo);
	                    ...
	                    redirect('admin/siswa');
							...
							$this->m_siswa->update_siswa_tanpa_img($kode,$nis,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$alamat,$kontak);
							echo $this->session->set_flashdata('msg','info');
							redirect('admin/siswa');
	            } 
