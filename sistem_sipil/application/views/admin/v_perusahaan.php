  	...
  	<div class="wrapper">
  		...
  		<div class="content-wrapper">
  				...
  				<div class="row">
  					<div class="col-xs-12">
                          ...
                          $id=$i['id_proyek'];
  												$Progress=$i['progress'];
  												$owner=$i['owner'];
  												$kontraktor=$i['kontraktor'];
  												$nilai=$i['nilai'];
  												$deskripsi=$i['deskripsi'];
                          $foto=$i['foto'];
                          $file=$i['file'];
                          $status=$i['Status_proyek'];
                          $nama1=$i['Nama1'];
                          $nama2=$i['Nama2'];
  												?>
  												<tr>
                            ...
                            <td><?php echo $nilai;?></td>
  													...
  													<td><a href="<?php echo base_url().'admin/perusahaan/downloadfoto/'.$id;?>"><?php echo $foto;?></a></td>
  													<td><a href="<?php echo base_url().'admin/perusahaan/downloadfile/'.$id;?>"><?php echo $file;?></a></td>
  			...
  			<footer class="main-footer">
  				...
  				<strong> <a href="">Teknik Sipil</a>.</strong>
  	...
  	<div class="modal fade" id="ModalEdit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  		<div class="modal-dialog" role="document">
  			<div class="modal-content">
  				...
  				<form class="form-horizontal" action="<?php echo base_url().'admin/perusahaan/update_file'?>" method="post" enctype="multipart/form-data">
  					<div class="modal-body">
  					
  						<div class="form-group">
                  <label for="inputUserName" class="col-sm-4 control-label">Validasi</label>
                  <div class="col-sm-7">
                      ...
                      <?php if($status=='0'):?>
                        ...
                        <option value="1">Sudah divalidasi</option>
                          <?php else:?>
                            ...
                            <option value="1" selected>Sudah divalidasi</option>
                          <?php endif;?>
                    </select>
                  </div>
              </div>
  ...
  <?php foreach ($data->result_array() as $i) :
  	...
  	<div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  		<div class="modal-dialog" role="document">
              ...
              <input type="hidden" name="file" value="<?php echo $foto;?>">
  						<p>Apakah Anda yakin mau menghapus file ?</p>
