       ...
       <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/download/simpan_file'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Nama File</label>
                                <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                  ...
                                  NB: file harus bertype pdf|doc|docx|zip. ukuran maksimal 2,7 MB.
                                </div>
                            </div>
