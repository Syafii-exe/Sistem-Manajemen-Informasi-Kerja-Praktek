...
<head>
    ...
    <!-- Title Page-->
    <title>Pengumpulan Kerja Praktek</title>
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title">Pengumpulan Kerja Praktek Mahasiswa Teknik Sipil </h2>
                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="form-row">
                            <div class="name">Upload Laporan Kerja Praktek</div>
                            <div class="value">
