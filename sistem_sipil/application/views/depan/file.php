                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li>
                                    ...
                                    <?php } elseif($proyek['Status_proyek']=='1' && $daftar['Status_daftar']=='1' && $file['status_surat']=='0' ) {?>
                                        <a href="<?php echo site_url('mahasiswa/File');?>"><i class="menu-icon icon-paste"></i>Upload Berkas Surat</a>
                                    <?php } elseif($proyek['Status_proyek']=='0' && $daftar['Status_daftar']=='1' && $file['status_surat']=='0' ) {?>    
                                        <a href="<?php echo site_url('mahasiswa/Perusahaan');?>"><i class="menu-icon icon-paste"></i>Upload Berkas Surat</a>
                                    <?php } else {?>
                                        <a href="<?php echo site_url('mahasiswa/daftar');?>"><i class="menu-icon icon-paste"></i>Upload Berkas Surat</a>   
                                    <?php } ?>
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="<?php echo base_url().'mahasiswa/File/simpan'?>" method="post" enctype="multipart/form-data">

                                        <div class="control-group">
                                            <label for="basicinput" class="control-label">Upload File Keterangan Mulai Kerja Praktek</label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <label for="basicinput" class="control-label">Upload File Keterangan Selesai Kerja Praktek</label>
                                            <div class="controls">
